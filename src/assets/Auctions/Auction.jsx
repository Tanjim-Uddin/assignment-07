        ...
        <>
            {
                ...
                return (
                    ...
                    <div className={` text-xl font-medium flex gap-20 items-center   p-6   bg-white border-l-2 border-r-2 border-b-2 border-black ${isLast ? "rounded-bl-2xl rounded-br-2xl " : ""}`} key={auction.id}>
